...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="section-padding bg-agr-dark relative overflow-hidden" ref={sectionRef}>
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col items-center">
                <h3 className="text-xl font-semibold text-center text-white mb-2">{solution.title}</h3>
