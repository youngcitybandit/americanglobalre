      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-agr-lightBlue rounded-2xl p-8 md:p-10">
            ...
            <div className="mt-12">
              <h4 className="font-semibold text-agr-blue mb-4">Connect With Us</h4>
              <div className="flex space-x-4">
                <a href="#" className="bg-white rounded-full p-3 text-agr-brightBlue hover:bg-agr-brightBlue hover:text-white transition-colors">
