      ...
      <div className="pt-32 pb-20 bg-gradient-to-b from-white to-gray-100">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
            <h1 className="text-2xl md:text-3xl font-bold text-center text-agr-dark mb-6">Broker Login</h1>
            <p className="text-gray-600 text-center mb-8">
              Access your account to manage your client insurance policies and partner benefits.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center text-sm text-gray-600">
                <span>Need broker registration? </span>
                <a href="#" className="font-medium text-agr-brightBlue hover:text-agr-blue">
